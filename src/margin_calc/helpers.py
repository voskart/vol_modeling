...
def put_call_parity(put: Position = None, call: Position = None) -> float:
    ...
    assert call.expiration_days == put.expiration_days, "TTE not equal!"
    assert call.strike == put.strike, "Strikes not equal!"
    expiry = call.expiration_days
    strike = call.strike
    spot = call.idxPx
